...
public class ValidationProjetsController implements Initializable {
    @FXML
    private TableColumn<ModeleViewAdmin, String> colName,colDate, colCat,colCréateur;
    @FXML
    ...
    @FXML
    private TableColumn<ModeleViewAdmin, String> colContrepartie;
    ...
    public ValidationProjetsController() {
    ...
    PreparedStatement preparedStatement = null;
      // affichage des projets dans la table pour admin qui non pas encore validé

    public void ViewProjects() {
        String type = "SELECT NomProjet,Catégorie,DateCréation,Budget,Contrepartie,CinUtilisateur,Image,etat FROM projet where etat='Non validé' ";
        ...
        try {
            ...
            System.err.println("Erreur d'affichage des projets qui ne sont pas encore validés");
        }
